...
维度 | 追求"更强" | 追求"更稳"  
---|---|---  
核心假设 | AI足够聪明，只需要给任务 | AI需要约束，否则会乱来  
解决的问题 | 写代码的速度 | 代码能不能用  
典型场景 | "帮我做个购物车" → 2分钟生成 | "帮你把购物车做对" → 10分钟确认+实现  
失败成本 | 高（生成完要大量返工） | 低（每一步都验证）  
...
![TDD 红-绿-重构循环流程图](/images/superpowers-guide/tdd-cycle.svg) TDD 红-绿-重构循环：Superpowers 强制执行"先写测试 → 通过测试 → 重构优化"
