---
title: 隐含相关性指数与相关性风险溢价：相关也能成为因子
publishDate: '2026-07-12'
description: 隐含相关性指数与相关性风险溢价：相关也能成为因子 - halo的技术博客
tags:
  - 量化交易
  - 量化专栏
  - 波动率
...
![隐含相关性长期高于已实现相关性，危机中倒挂](/images/implied-correlation/implied_vs_realized_corr.png)
...
![分散度交易：指数波动率随相关性上升，成分波动不变](/images/implied-correlation/dispersion_trade.png)
...
![做空相关性策略：平日薄利、危机中被相关性飙升重创](/images/implied-correlation/short_corr_strategy.png)
...
def correlation_regime_signal(rho_impl, rho_real, lookback=252):
    ...
    impl_pct = (rho_impl < np.sort(rho_impl[-lookback:])[:, None]).mean()  # 分位示意
    if crp < 0:
