...
description: "相关系数在平静市场里很好用，但危机来临时它会彻底失灵——2008 与 2020 年我们都见过「所有资产一起跳水、相关性冲到 1」。Copula 模型把边际分布与相依结构解耦，让我们能单独建模尾部相依（tail dependence）。本文用 scipy 从零构建高斯 copula 与 t-copula，量化危机时资产如何联动，并对比两种假设下组合 VaR 的差距。"
