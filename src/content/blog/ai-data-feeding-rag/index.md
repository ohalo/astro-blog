...
RAG 的解决思路是这样的：
  ...
  1. **把你的文档存进"私有书架"** （向量数据库）
  2. **问问题时，先去书架里翻相关的几页** （向量检索）
  3. **把这几页内容连同问题一起拍在AI面前** （上下文增强）



![RAG工作原理流程图](/images/ai-data-feeding-rag/rag-flow.svg)
...
### 最简单的方式：AnythingLLM
  ...
  1. 下载安装 AnythingLLM
  2. 新建工作区，上传你的文档（支持 PDF、TXT、Word、Excel、PPT）
  3. 勾选文件，点击【Move to Workspace】
  4. 点击【Save and Embed】
