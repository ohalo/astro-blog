...
![上下文利用率超过40%，Agent质量断崖下降](/images/harness-six-layer/context-smart-dumb.png)
...
![Harness Engineering 六层架构](/images/harness-six-layer/six-layer-architecture.png)
...
他的六步路线很实用：
  ...
  1. 放弃聊天模式，让 Agent 在能读文件、跑程序的环境里直接干活
  2. 每件事做两次——一次自己做，一次让 Agent 做（他说"痛苦至极"但这是最快学习路径）
  3. 下班前 30 分钟启动 Agent 做调研、Issue 分拣
  4. 挑出 Agent 几乎一定能做好的确定性任务后台跑
  5. 每当 Agent 犯了一个新类型的错，就工程化一个解决方案让它永远不再犯
