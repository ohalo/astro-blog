...
description: "CAPM 说高风险高回报——beta 越高的股票预期收益越高，证券市场线（SML）应该是一条陡峭的斜线。但几十年的实证反复发现：真实的 SML 比 CAPM 预测的平坦得多，低 beta 股票的风险调整后收益系统性地高于高 beta 股票。Frazzini-Pedersen 的解释不是『市场无效』，而是『杠杆约束』：很多投资者（共同基金、散户）想要高收益却不能借钱加杠杆，只好超配高 beta 股票——把高 beta 买贵了（未来收益被压低），把低 beta 冷落了（相对便宜）。固定种子（20260801）的受控模拟严格设定真实 alpha=0，任何低beta溢价只能来自这个杠杆扭曲：SML 斜率从 CAPM 的 11.4% 被压平到 4.6%（截距抬到 7.5%）。BAB 因子做多低beta并加杠杆到beta=1、做空高beta并去杠杆到beta=1，实现 Sharpe 1.65 远超市场买入持有的 0.64，且对市场的 beta 只有 0.052（真正的市场中性）。但它有个致命软肋：低beta腿必须真金白银加杠杆，融资成本年化到 3% 时 Sharpe 从 1.65 掉到 1.2、到 8% 时只剩 0.45——BAB 赚的正是别人不能加杠杆的钱，而你能不能低成本加杠杆，决定了这个溢价你吃不吃得到。对抗式检验：无杠杆扭曲的世界里 BAB Sharpe 变成 -0.22（证明溢价来自扭曲而非数据挖掘），随机分组 300 次置换 95 分位仅 0.55。四项检验全过。"
