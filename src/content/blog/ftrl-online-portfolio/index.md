...
description: "FTRL(Follow The Regularized Leader)把「跟随历史最优」写成带自适应学习率与 L1/L2 正则的逐坐标在线更新，移植到在线投资组合选择。6 资产 3 年合成回测总收益 80.1%（UCRP 39.7%、OLMAR 36.5%），Sharpe 0.94、日均换手仅 3.9%、稀疏度 41%，20 种子 12/20 跑赢 UCRP（高阶）。"
