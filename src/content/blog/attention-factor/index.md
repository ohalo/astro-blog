...
description: "把注意力机制(Attention)从 NLP/CV 搬进多因子选股：用特征级自注意力让模型在「价值/动量/质量…」之间学会「看谁」，再用注意力权重对原始因子做门控加权得到 1 维注意力因子。合成实验里注意力 vs 真值 IC=0.999、IG 归因锁定动量、门控因子 OOS R²=0.59 远超等权平均的 0.15（高阶）。"
