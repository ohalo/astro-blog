...
- [2026-06-13 - 行为金融学在量化策略中的应用：捕捉市场非理性带来的阿尔法](/blog/behavioral-finance-quant/) - 🟡 详解前景理论、处置效应、羊群效应等行为金融学理论，并提供可量化的交易策略及中国股市实证分析（进阶）
- [2026-06-13 - 风险平价策略在中国市场的实证：从理论到实战](/blog/risk-parity-china/) - 🟡 深入探讨风险平价策略在中国A股市场的实证表现、HRP层次风险平价及动态杠杆管理方法（进阶）

- [2026-06-13 - 期权波动率交易与Delta中性策略](/blog/2026-06-13-options-volatility-trading/) - 🔴 详解期权波动率交易核心逻辑、Delta中性策略、Straddle/Iron Condor等实战策略及Greek风险管理（高阶）
- [2026-06-13 - VaR与CVaR风险度量方法实战](/blog/2026-06-13-var-cvar-risk-management/) - 🟡 深入解析VaR/CVaR计算方法（历史模拟/参数法/蒙特卡洛）、回测框架及在量化组合风险管理中的实战应用（进阶）
...
- [2026-06-14 - 低波动因子策略：超越CAPM的阿尔法源泉](/blog/2026-06-14-low-volatility-factor/) - 🟡 深入探讨低波动因子的理论基础、实证表现、构建方法以及在中国市场的应用实践，提供完整Python代码（进阶）
- [2026-06-14 - 卫星图像另类数据：用太空之眼捕捉投资先机](/blog/2026-06-14-satellite-alternative-data/) - 🟡 详解卫星图像另类数据的原理、数据源、分析方法及实战案例，涵盖目标检测、变化检测、阴影分析等技术（进阶）

- [2026-06-13 - 随机森林在量化选股中的应用：特征工程与模型优化实战](/blog/2026-06-13-random-forest-stock-selection/) - 🟡 深入探讨随机森林在量化选股中的应用，从特征工程、模型训练到实盘部署，提供完整的实战框架及A股回测结果（进阶）
...
- [2026-06-12 - 配对交易实务：从协整检验到实盘执行](/blog/2026-06-12-pairs-trading-practice/) - 🟡 深入探讨配对交易完整实务流程：协整检验(ADF测试)、Z-Score信号设计、对冲比率动态更新及中国市场做空限制的应对策略（进阶）
- [2026-06-12 - 另类数据实战：社交媒体情绪分析在量化投资中的应用](/blog/2026-06-12-social-media-sentiment/) - 🟡 详解社交媒体情绪分析方法论(词典法/机器学习/深度学习)、交易信号构建、噪音过滤及GameStop事件案例研究（进阶）
...
- [2026-06-13 - 限价订单簿建模与高频策略：捕捉微观结构阿尔法](/blog/2026-06-13-lob-modeling-hft/) - 🔴 深入探讨限价订单簿(LOB)建模方法、特征工程、LSTM/XGBoost预测模型及做市商/订单流交易策略实战（高阶）
- [2026-06-13 - 强化学习在量化交易中的应用：从Q-Learning到深度强化学习实战](/blog/2026-06-13-reinforcement-learning-trading/) - 🔴 深入探讨强化学习在量化交易中的应用，从Q-Learning、DQN到PPO/Actor-Critic，提供完整Python实战代码及实盘挑战分析（高阶）
- [2026-06-13 - 最优执行算法详解：从VWAP到强化学习驱动的现代交易系统](/blog/2026-06-13-optimal-execution-algorithms/) - 🔴 详解最优执行算法(VWAP/TWAP/POV/IS)、机器学习成交量预测、强化学习执行智能体及实盘中的隐藏单/冰山单处理（高阶）
- [2026-06-12 - 基于LSTM的股价预测实战：从数据预处理到模型部署](/blog/lstm-stock-prediction-practical/) - 🔴 从零实现LSTM股价预测系统，涵盖数据预处理、模型训练、回测框架及实盘部署注意事项（高阶）
- [2026-06-12 - 期权波动率策略详解：从Vega到实盘交易](/blog/options-volatility-strategies/) - 🔴 详解期权波动率交易的核心原理、常见策略(Straddle/Strangle/Iron Condor)、Vega对冲及A股50ETF期权实证（高阶）
